...
public class adminSide_FAQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_side_faq);
    ...
    public class HttpGetRequest extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result){
            ...
            try {
                ...
                final StableArrayAdapter adapter = new StableArrayAdapter(adminSide_FAQ.this,
                ...
                listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, final View view,
                        ...
                        Intent i = new Intent(adminSide_FAQ.this, AdminSide_FAQ_Answer.class);
                        i.putExtra("position", position + 1);
                        i.putExtra("question",questionBase.get(position));
                        startActivity(i);
                    }
                });
                ...
                e.printStackTrace();
                Toast.makeText(adminSide_FAQ.this, "Oops !", Toast.LENGTH_LONG).show();
            }
