...
public class Student_side_training extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_side_training);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Student_side_training.this,obj.getString("message"), Toast.LENGTH_SHORT).show();
                            ...
                            pdfAdapter=new PdfAdapter(Student_side_training.this,R.layout.list_layout, pdfList);
